// Отправляет фото документа модели Claude и просит вернуть строго JSON
// с нужными полями. Один и тот же принцип для любого типа документа —
// меняется только список полей и подсказка, что это за документ.
...
const PROMPTS = {
  ...
  passport_registration: {
    label: "разворот паспорта с адресом регистрации",
    fields: `{ "address": "полный адрес регистрации одной строкой" }`,
  },
  vehicle_doc: {
