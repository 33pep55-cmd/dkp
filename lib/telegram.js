...
// Убирает список команд (/start, /new и т.д.) и сам значок "меню" ☰
// рядом с полем ввода — чтобы у пользователя не было второго, скрытого
// способа управления ботом в обход наших видимых inline-кнопок.
