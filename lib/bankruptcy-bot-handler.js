...
const INTERMEDIATE_GENERATORS = {
  ip_closure_p26001: { fn: generateIpClosureApplication, filename: "zayavlenie_zakrytie_ip.docx", caption: "📄 Заявление на закрытие ИП (форма Р26001) готово. Лист 2 при подаче заполнит сотрудник ФНС/МФЦ — самостоятельно его заполнять не нужно." },
};
