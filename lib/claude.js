...
const PROMPTS = {
  ...
  passport_registration: {
    ...
    fields: `{ "address": "полный адрес регистрации одной строкой, ПОЛНОСТЬЮ, без сокращений и без пропусков" }`,
    extra: "Штамп регистрации обычно состоит из нескольких строк (индекс, регион/область, район, город/населённый пункт, улица, дом, корпус/строение, квартира) — прочитай ВСЕ строки штампа и собери их в один полный адрес, ничего не обрезая и не сокращая. Если штампов о регистрации несколько — используй самый последний (актуальный) по дате, но прочитай его целиком, от индекса до номера квартиры. Не прекращай чтение на середине адреса.",
  },
  vehicle_doc: {
